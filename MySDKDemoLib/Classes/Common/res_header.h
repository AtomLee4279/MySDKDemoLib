...
#define SDKUIVersion @"1"

#define SDKLibVersion [[[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleShortVersionString"] stringByAppendingFormat:@".%@",SDKUIVersion]
